 ...
 */
export function wrapOpenAI<T extends any>(client: T): T {
  ...
  if (!chat || !chat.completions || typeof chat.completions.create !== 'function') {
    console.warn('[llm-autopilot] wrapOpenAI: Could not find chat.completions.create on the provided client.');
    return client;
  }
 ...
 */
export const wrapGroq = wrapOpenAI;
